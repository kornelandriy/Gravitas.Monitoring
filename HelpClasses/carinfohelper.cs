...
{
	public static class carinfohelper
	{
		private static string CurTC = "";
		private static string CurT = "";

		public static string ShowRoute(string RouteTemplateId, string LastRouteItem, string LastNode, string t, string tc)
		{
		...
		private static string RouteParser(string s)
		{
			string r = "";
			int iGroup = 0;
			string i1 = "{\"groupId\"";
		...
		private static string RouteParserClear2(string s)
		{
			string oldGroupNum = "#";
			s = s.Replace("\r", "");
		...
		public static List<string[]> CarProgress = new List<string[]>();

		public static string[] StatusNamesForNode = new string[]
	   {
			"",
			"Бланк", // 1
            "В обробці", // 2
		...
		public static string GetNodeStatus(string id)
		{
			int n = 0;
		...
		private static List<string> GetTList(string tc)
		{
		...
		public static string GetNodeDataByTC(string tc)
		{
			if (tc == "") return "";
		...
		private static void GetNodeDataByT(string t)
		{
